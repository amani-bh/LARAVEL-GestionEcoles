        ...
        <div class="row">
          <div class="col-12">
            <div class="card mb-4">
              ...
              <h4 class="mb-1" style="color: purple;">Evenements</h4>
                <b class="text-sm">Liste des évènements</b>
              </div>
                      ...
                      @foreach($evenements as $evenement)
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{$evenement->titre_event}}</h6>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span class="badge badge-sm bg-gradient-success">{{$evenement->date_fin}}</span>
                        </td>
                        <td class="align-middle text-center">
                          <span class="text-secondary text-xs font-weight-bold">{{$evenement->place}}</span>
                        </td>
                        <td class="align-middle text-center">
                           <span class="text-secondary text-xs font-weight-bold">{{$evenement->description}}</span>
                        </td>
                        <td class="align-middle text-center">
                           <span class="text-secondary text-xs font-weight-bold">{{$evenement->createur}}</span>
                        </td>
                        <td class="align-middle">
                            <form action="{{route('destroyeventadmin', $evenement->id)}}" method="post">
                                @csrf
                                @method('post')
